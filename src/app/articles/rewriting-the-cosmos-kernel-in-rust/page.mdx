...
export const article = {
  author: 'Certificado Microfrontends',
  date: '2022-01-09',
  title: 'Certificado Microfrontends',
  description:
    'Certificado que avala mi habilidad para construir aplicaciones escalables y modulares con React, aplicando la arquitectura de Microfrontends para mejorar la integración y comunicación entre módulos.',
}
