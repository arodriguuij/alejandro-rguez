...
export const article = {
  author: 'Certificado metodología SAFe',
  date: '2022-05-14',
  title: 'Certificado metodología SAFe',
  description:
    'Metodología de trabajo para equipos grandes donde se requiere organización entre equipos para una mayor compatibilidad y agilidad a la hora de desarrollar software.',
}
