...
export const article = {
  author: 'Aplicación web de medicina estética',
  date: '2024-11-09',
  title: 'Aplicación web de medicina estética',
  description:
    'Web para una clínica de medicina estética con listados de tratamientos (imágenes de antes y después), productos, información sonbre la clínica y los doctores, compra de tarjetas de regalo, ...',
}
