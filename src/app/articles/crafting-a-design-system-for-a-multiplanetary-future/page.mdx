...
export const article = {
  author: 'Grado en Ingeniería Informática de Software',
  date: '2017-07-05',
  title: 'Grado en Ingeniería Informática de Software',
  description:
    'Certificado de Ingeniería Informática en la Escuela Politécnica (Universidad de Extremadura). Nota media 8.',
}
